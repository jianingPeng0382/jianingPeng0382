...
- **StructGen: Disambiguating Multi-Reference Image Generation via Structured Context Modeling** — *ACM Multimedia 2026*. Structured context modeling for precise attribute-subject grounding in multi-reference generation. [[page](https://jianingpeng0382.github.io/StructGen/)] [[paper](https://arxiv.org/pdf/2607.15619)] [[code](https://github.com/jianingPeng0382/StructGenCode)]
...
- **On Exact Editing of Flow-Based Diffusion Models** — Exact image editing through flow-based diffusion modeling. [[paper](https://arxiv.org/abs/2512.24015)]
