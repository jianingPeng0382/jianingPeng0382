...
- **StructGen: Disambiguating Multi-Reference Image Generation via Structured Context Modeling** — *ACM MM 2026*. Structured context modeling for precise attribute-subject grounding in multi-reference generation. [[page](https://jianingpeng0382.github.io/StructGen/)] [[paper](https://arxiv.org/abs/2607.15619)] [[code](https://github.com/jianingPeng0382/StructGenCode)]
...
- **DCEdit: Dual-Level Controlled Image Editing via Precisely Localized Semantics** — *ACM MM Workshop 2025*. Precise local image editing through dual-level semantic control. [[paper](https://arxiv.org/abs/2503.16795)] [[code](https://github.com/YihanHu-2022/DC-Edit)]
- **On Exact Editing of Flow-Based Diffusion Models** — *Under Review, AAAI 2027*. Exact image editing through flow-based diffusion modeling. [[paper](https://arxiv.org/abs/2512.24015)]
